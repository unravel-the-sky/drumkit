...
console.log('yellooo'); // const sounds = {
//   A: {
//     name: 'Clap',
...
var app = document.getElementById('drumkit-app');
var drumkitPanel = document.getElementById('drumkit-elements');

var prepareDrumkitPanel = function prepareDrumkitPanel() {
  soundsArray.map(function (item) {
    ...
    element.addEventListener('click', function (e) {
      ...
      playSound(item.key, item.sound);
    });
    drumkitPanel.appendChild(element);
  });
};

function playSound(key, path) {
